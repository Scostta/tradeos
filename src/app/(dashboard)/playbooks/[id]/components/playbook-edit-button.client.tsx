  ...
  return (
    <PlaybookEditor
      ...
      renderTrigger={(open) => (
        <button
          onClick={open}
          className="flex items-center gap-1.5 px-3 h-[30px] rounded-sm text-base text-text-dim border border-border hover:border-border-hi transition-colors whitespace-nowrap cursor-pointer"
        >
